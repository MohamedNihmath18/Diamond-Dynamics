...
@st.cache_resource
def load_models():
    reg_model      = joblib.load(os.path.join(BASE_DIR, 'models', 'xgb_model.pkl'))
    cluster_model  = joblib.load(os.path.join(BASE_DIR, 'models', 'kmeans_model.pkl'))
    scaler         = joblib.load(os.path.join(BASE_DIR, 'models', 'scaler.pkl'))
    scaler_cluster = joblib.load(os.path.join(BASE_DIR, 'models', 'scaler_cluster.pkl'))
    cluster_names  = joblib.load(os.path.join(BASE_DIR, 'models', 'cluster_names.pkl'))
...
@st.cache_data
def load_data():
    return pd.read_csv(os.path.join(BASE_DIR, 'data', 'diamonds_final.csv'))
...
st.markdown('---')
st.caption('💎 Diamond Dynamics | Data Science Project | XGBoost + KMeans')